"""Tests for the PyBulletFloatEnv environment."""
...
def env():
    ...
    try:
        ...
        return PyBulletFloatEnv(config=config, use_gui=False)
    except Exception as exc:
        pytest.skip(f"Cannot instantiate PyBulletFloatEnv: {exc}")


def test_name(env):
    """get_name() returns the expected identifier."""
    assert env.get_name() == "pybullet_float"
